...
const getPhotoUrl = (photoReference) => {
  return new Promise((resolve, reject) => {
    const url =
      "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&chunked_encoding=true&photo_reference=" +
      decodeURIComponent(photoReference) +
      "&key=" +
    ...
    request(
      ...
      (error, body) => {
        if (error) {
          ...
          resolve(
            "https://lh3.googleusercontent.com" + body.client._httpMessage.path
          );
        }
      }
    );
